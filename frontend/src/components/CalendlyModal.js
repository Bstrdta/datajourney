        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary-dark to-blue-900 text-white p-6 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold mb-2">Réservez votre audit gratuit</h2>
                <p className="text-neutral-300">30 minutes pour analyser vos besoins et définir votre stratégie Power BI</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="h-[calc(100%-120px)]">
              <iframe
                ...
                height="100%"
                frameBorder="0"
                title="Réserver un audit gratuit - Calendly"
