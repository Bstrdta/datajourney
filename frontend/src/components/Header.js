...
const Header = () => {
  ...
  return (
    <motion.header
      className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-primary-dark/20 backdrop-blur-md border-b border-white/10"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:block">
            <motion.button
              className="bg-primary-turquoise text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-green-600 transition-all duration-300 backdrop-blur-sm"
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg transition-colors duration-300 text-white hover:bg-white/10 backdrop-blur-sm"
          >
